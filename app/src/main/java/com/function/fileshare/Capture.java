...
public class Capture extends Activity {
    ...
    private String TAG = Capture.class.getSimpleName();
    ...
    private GeocodeSearch geocoderSearch;
	 ...
	 protected void onCreate(Bundle savedInstanceState) {  
	     ...
	     //bug：进入拍照界面不能取消
	     TextView cameraTV=(TextView) findViewById(R.id.photo_camera_tv);
	     TextView albumTV=(TextView) findViewById(R.id.photo_album_tv);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data){
	 ...
	 private void initView() {
	     ...
	     tbTitle.setOnClickLisenerL(new OnClickListenerL() {
	    	 @Override
	    	 public void onClick(View v) {
	    		 Intent intent = new Intent(Capture.this, MainScreen.class);
	    		 startActivity(intent);
	    	 }
	     });
	        //设置中间的标题
	     tbTitle.setTitleText("图像捕捉");
...
public class Capture extends Activity implements GeocodeSearch.OnGeocodeSearchListener {
    private MyTitleBar tbTitle;
    private TextView albumTV;
    private TextView cameraTV;
    private TextView phoneTV;
    ...
    private void selectPhoto(int type) {
        ...
        if (type == RESULT_IMAGE_CODE) {
            startActivityForResult(
                    new Intent(Intent.ACTION_PICK).setType("image/*").putExtra(
                            MediaStore.EXTRA_OUTPUT, Uri.fromFile(tmpCameraFile)),
                    RESULT_IMAGE_CODE);
...
//            latLng = new LatLng(currentLat, currentLon);
        ...
        // 反地理编码
        geocoderSearch = new GeocodeSearch(Capture.this);
        geocoderSearch.setOnGeocodeSearchListener(Capture.this);
